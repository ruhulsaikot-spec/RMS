...
"[project]/src/app/admin/reports/claims/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ClaimsReportPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ClaimsReportPage.useEffect": ()=>{
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].get("/departments/").then({
                "ClaimsReportPage.useEffect": (r)=>setDepartments(r.data)
            }["ClaimsReportPage.useEffect"]).catch({
                "ClaimsReportPage.useEffect": ()=>{}
            }["ClaimsReportPage.useEffect"]);
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].get("/designations/").then({
                "ClaimsReportPage.useEffect": (r)=>setDesignations(r.data)
            }["ClaimsReportPage.useEffect"]).catch({
                "ClaimsReportPage.useEffect": ()=>{}
            }["ClaimsReportPage.useEffect"]);
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].get("/reports/employees").then({
                "ClaimsReportPage.useEffect": (r)=>setEmployees(r.data)
            }["ClaimsReportPage.useEffect"]).catch({
                "ClaimsReportPage.useEffect": ()=>{}
            }["ClaimsReportPage.useEffect"]);
    ...
    const fetchReport = async (f = filters)=>{
        try {
            ...
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].get(`/reports/claims?${params.toString()}`);
            setRows(res.data);
        } catch (e) {
            console.error(e);
        } finally{
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                                                ...
                                                                children: [
                                                                    ...
                                                                    designations.map((d)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                                            value: d.id,
                                                                            className: "bg-[#0d1628]",
                                                                            children: d.name
                                                                        }, d.id, false, {
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                                                ...
                                                                children: [
                                                                    ...
                                                                    employees.map((d)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                                            value: d.id,
                                                                            style: {
...
_s(ClaimsReportPage, "YWFhgUnEplMh/EQKP8vVooYbW+Y=");
_c = ClaimsReportPage;
var _c;
__turbopack_context__.k.register(_c, "ClaimsReportPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_0tdjv0c._.js.map