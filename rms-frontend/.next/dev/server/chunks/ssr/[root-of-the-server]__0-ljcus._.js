...
"[project]/src/app/admin/reports/department-wise/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function DepartmentWiseReportPage() {
    ...
    const fetchReport = async (f = filters)=>{
        try {
            ...
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].get(`/reports/department-expense?${params.toString()}`);
            setRows(res.data);
        } catch (e) {
            console.error(e);
        } finally{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0-ljcus._.js.map