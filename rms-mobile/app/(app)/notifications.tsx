...
const styles = StyleSheet.create({
  ...
  unreadCount: { color: "#0891b2", fontSize: 12, marginTop: 2 },
  markAllBtn: {
  ...
  markAllText: { color: "#0891b2", fontSize: 11, fontWeight: "600" },
  ...
  cardTitle: { color: "#94a3b8", fontSize: 13, fontWeight: "600", flex: 1 },
  unreadTitle: { color: "#fff" },
  ...
  cardTime: { color: "#475569", fontSize: 10 },
